...
export interface AfterSalesOrderLine { salesOrderItemId:number; skuId:number; skuCode?:string; productName?:string; model?:string; configuration?:string; unit?:string; shippedQuantity:number; availableReturnQuantity:number }
...
export interface AfterSalesReplacementLine { id?:number; returnLineId?:number; salesOrderItemId?:number; skuId:number; skuCode?:string; productName?:string; model?:string; configuration?:string; unit?:string; plannedQuantity:number; shippedQuantity?:number; availableQuantity?:number }
