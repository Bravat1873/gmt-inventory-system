...
export const moduleDefinitions: ModuleDefinition[] = [
  ...
  { key: 'product', label: '产品管理', description: '维护产品编号、客户编号、品牌系列及产品资料', actionLabel: '导入产品', columns: ['图片', '产品编号', '客户料号', '品牌', '型号', '产品分类', '物料类型', '物料规格', '产品配置', '销售最小起订量', '供应商报价', '备注', '修改时间'], fields: ['productImage', 'productCode', 'customerCode', 'brand', 'model', 'productType', 'materialType', 'configuration', 'productConfiguration', 'salesMinimumOrderQuantity', 'supplierQuotes', 'remark', 'updatedAt'], sortable: ['', 'productCode', 'customerCode', '', 'model', '', '', '', '', 'salesMinimumOrderQuantity', '', '', 'updatedAt'], importType: 'COST' },
