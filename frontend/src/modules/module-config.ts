...
{ key: 'inventory', label: '库存管理', description: '字段与“吉门第库存汇总表.xlsx”保持一致', actionLabel: '导入库存', columns: ['产品编号', '型号', '产品类型', '产品配置', '物料规格', '单位', '实际库存数量', '可用库存数量', '最早在库日期', '库龄', '已锁定数量', '在途数量', '供应商', '备注', '修改时间'], fields: ['productCode', 'model', 'productType', 'productConfiguration', 'configuration', 'unit', 'actualQuantity', 'availableQuantity', 'oldestStockDate', 'inventoryAgeDays', 'lockedQuantity', 'inTransitQuantity', 'sourceSupplierName', 'inventoryRemark', 'updatedAt'], sortable: ['productCode', 'model', '', '', '', '', 'actualQuantity', 'availableQuantity', '', '', '', '', '', '', 'updatedAt'], importType: 'INVENTORY' },
