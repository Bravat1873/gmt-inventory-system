export type ModuleKey = 'customer' | 'user' | 'product' | 'order' | 'inventory' | 'purchase' | 'finance'
...
export const moduleDefinitions: ModuleDefinition[] = [
  ...
  { key: 'purchase', label: '采购管理', description: '处理缺货采购及供应商订单', actionLabel: '生成采购', columns: ['采购单号', '供应商 ID', '供应商', '产品 ID', '产品', '采购金额', '订单状态', '预计到货', '修改时间'], fields: ['purchaseNo', 'supplierId', 'supplierName', 'productIds', 'productSummary', 'totalAmount', 'status', 'expectedArrivalDate', 'updatedAt'], sortable: ['purchaseNo', 'supplierId', 'supplierName', '', '', 'totalAmount', 'status', '', 'updatedAt'] },
