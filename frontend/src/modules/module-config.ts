...
export const moduleDefinitions: ModuleDefinition[] = [
  ...
  { key: 'product', label: '产品管理', description: '维护产品编号、客户编号、品牌系列及产品资料', actionLabel: '导入产品', columns: ['图片', '产品编号', '客户编号', '品牌', '系列', '产品分类', '物料类型', '物料规格', '成本单价（含税）', '转厂价格', '差异：转厂价-原成本', '备注', '修改时间'], fields: ['productImage', 'productCode', 'customerCode', 'brand', 'series', 'productType', 'materialType', 'configuration', 'currentCost', 'factoryPrice', 'priceDifference', 'remark', 'updatedAt'], sortable: ['', 'productCode', 'customerCode', '', '', '', '', '', 'currentCost', 'factoryPrice', 'priceDifference', '', 'updatedAt'], importType: 'COST' },
...
{ key: 'inventory', label: '库存管理', description: '字段与“吉门第库存汇总表.xlsx”保持一致', actionLabel: '导入库存', columns: ['物料编号 SKU', '型号', '产品配置', '版本', '颜色', '锁体', '单位', '实际库存数量', '可用库存数量', '最早在库日期', '库龄', '已锁定数量', '在途数量', '供应商', '备注', '修改时间'], fields: ['skuCode', 'model', 'configuration', 'productVersion', 'color', 'lockBody', 'unit', 'actualQuantity', 'availableQuantity', 'oldestStockDate', 'inventoryAgeDays', 'lockedQuantity', 'inTransitQuantity', 'sourceSupplierName', 'inventoryRemark', 'updatedAt'], sortable: ['skuCode', 'model', '', '', '', '', '', 'actualQuantity', 'availableQuantity', '', '', '', '', '', '', 'updatedAt'], importType: 'INVENTORY' },
