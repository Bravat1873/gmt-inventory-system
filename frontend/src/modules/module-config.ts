...
export const moduleDefinitions: ModuleDefinition[] = [
  ...
  { key: 'product', label: '产品管理', description: '字段与“产品成本单价汇总20260520.xlsx”保持一致', actionLabel: '导入产品', columns: ['图片', '物料编号', '型号', '颜色', '锁体', '物料规格', '成本单价（含税）', '转厂价格', '差异：转厂价-原成本', '备注', '修改时间'], fields: ['productImage', 'skuCode', 'model', 'color', 'lockBody', 'configuration', 'currentCost', 'factoryPrice', 'priceDifference', 'remark', 'updatedAt'], sortable: ['', 'skuCode', 'model', '', '', '', 'currentCost', 'factoryPrice', 'priceDifference', '', 'updatedAt'], importType: 'COST' },
