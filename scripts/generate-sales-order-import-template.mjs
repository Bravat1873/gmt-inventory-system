...
const outputPath = path.join(outputDir, "销售订单批量导入模板-数据库参考版.xlsx");
...
const exampleRows = [
  [
    "SAMPLE-ORDER-001", "CUS000001", new Date(Date.UTC(2026, 7, 18)), "工程订单", "正式订单",
    "管理员", "G_T5YZH60WPSC-M", "G8T5VMHS02", 1000, 0, "", "",
    "", "", "", "", "", "", "", "物流配送", "数据库参考：同一外部订单号的首条明细",
  ],
  [
    "SAMPLE-ORDER-001", "CUS000001", new Date(Date.UTC(2026, 7, 18)), "工程订单", "正式订单",
    "管理员", "BR_A71YZH60WPSE", "G8A71HS001", 1000, 0, "", "",
    "", "", "", "", "", "", "", "物流配送", "数据库参考：同一外部订单号的第二条明细",
  ],
  [
    "SAMPLE-ORDER-002", "CUS000002", new Date(Date.UTC(2026, 7, 19)), "零售订单", "草稿",
    "管理员", "G_T7PBY10WPSC-P", "G8T7VPYS01", 500, 0, "", "",
    "", "", "", "", "", "", "", "客户自提", "数据库参考：草稿订单不锁定库存",
  ],
];
...
const guideRows = [
  ...
  ["分组规则", "同单分组一致性", "同一外部订单号的客户编码、订单日期、订单类型、销售员、订单状态、联系人、收货信息和发货方式必须一致；备注按明细分别保存，可不同。", "SAMPLE-ORDER-001 的两行可填写不同明细备注"],
  ["唯一匹配", "客户编码", "客户编码必须唯一匹配一个已启用客户。", "CUS000001 取自本地开发数据库，仅供参考"],
  ["唯一匹配", "产品编号", "产品编号必须唯一匹配一个已启用产品；同一订单可填写多个不同产品。", "G_T5YZH60WPSC-M 取自本地开发数据库，仅供参考"],
  ...
  ["示例数据", "必须替换", "客户编码、产品编号、客户料号和销售员取自本地开发数据库；外部订单号和日期仅为示例。", "导入前请替换全部示例值"],
  ["字段", "必填/可选", "填写规则", "错误示例"],
  ...
  ["订单备注", "可选", "按当前产品明细保存，每行可填写不同备注，最多1000个字符。", "超过1000个字符"],
];
