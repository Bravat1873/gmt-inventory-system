...
public class CustomerFundController {
    ...
    @GetMapping("/customers/{customerId}/funds/orders") public ApiResponse<List<Map<String,Object>>> orderOptions(@PathVariable long customerId){return ApiResponse.ok(queries.orderOptions(customerId));}
