...
public class FinanceController {
    ...
    @PostMapping("/{id}/receipt") public ApiResponse<Map<String,Object>> receipt(@PathVariable long id,@RequestBody FinanceActionRequest request){return ApiResponse.ok(workflow.receipt(id,request));}
    ...
    @DeleteMapping("/{type}/{id}/invoices/{invoiceId}") public ApiResponse<Void> deleteInvoice(@PathVariable String type,@PathVariable long id,@PathVariable long invoiceId){invoices.delete(type,id,invoiceId);return ApiResponse.ok(null);}
    @PutMapping("/{type}/{id}/invoice") public ApiResponse<Map<String,Object>> saveInvoice(@PathVariable String type,@PathVariable long id,@RequestBody InvoiceRequest request){return ApiResponse.ok(invoices.save(type,id,request));}
    @DeleteMapping("/{type}/{id}/invoice") public ApiResponse<Void> deleteInvoice(@PathVariable String type,@PathVariable long id){invoices.delete(type,id);return ApiResponse.ok(null);}
