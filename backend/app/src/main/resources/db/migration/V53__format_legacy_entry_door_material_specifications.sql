-- Legacy entry-door rows predate the shared smart-lock code-rule selection.
-- Preserve their original door attributes in the same readable specification format.
UPDATE sku s
