...
CREATE TABLE sku(
    ...
    product_configuration VARCHAR(1000),
    color VARCHAR(100),
    lock_body VARCHAR(100),
...
CREATE TABLE purchase_invoice(id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,purchase_order_id BIGINT NOT NULL);
